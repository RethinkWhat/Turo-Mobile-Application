/**
 * This class represents the activity for viewing details of a pending tutor.
 * It displays information about the pending tutor, such as name, location, asking price, contact details,
